...
The second thing that we need is the data, the models use data to learn some thing. More data precizer is the model.

<!--stackedit_data:
eyJoaXN0b3J5IjpbMTg5ODMxMjI3MCwtMTM0OTg0NTIyNiwxOD
